...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000f41552499ede47d7f76aafaade710222ab9e1e183c96ccdae60757168ba"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526961223, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Wino cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526961223;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 25357568;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000f41552499ede47d7f76aafaade710222ab9e1e183c96ccdae60757168ba"));
        assert(genesis.hashMerkleRoot == uint256("0x61e2c153036cfed0383b1392c8a55e547c6d635ebd5ea50aec5a01b8e58746c6"));
        

        vSeeds.push_back(CDNSSeedData("seed.monitorit4.me", "seed.monitorit4.me"));
        vSeeds.push_back(CDNSSeedData("seed1.monitorit4.me", "seed.monitorit4.me"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1526961223; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1526961224;
        genesis.nNonce = 20843804;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000604d2d12e68b47cc4c2c44540bb00a5da33913f4538b6112ac67edada84"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Wino BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Wino BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Wino BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1526961224;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1526961225;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 4;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x09dc8c06614b7757affe7427cc0efaeac474b25b8c136a11a425b6495947edca"));
